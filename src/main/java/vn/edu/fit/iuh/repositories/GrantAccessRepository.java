...
import vn.edu.fit.iuh.database.Connection;
import vn.edu.fit.iuh.entities.GrantAccess;
import vn.edu.fit.iuh.entities.IsGrant;
...
public class GrantAccessRepository {
    ...
    public GrantAccessRepository(){
        this.em = (EntityManager) Connection.getInstance().getEntityManagerFactory().createEntityManager();
    }
